...
st.set_page_config(page_title="Furama Resort Da Nang – Jan 2026 vs Jan 2025", layout="wide")
...
st.title("Furama Resort Da Nang – Jan 2026 vs Jan 2025 comparison")
...
with tab1:
    ...
    with c1:
        st.metric("Net Jan 2025 (VND)", f"{net_2025:,.0f}", "")
    with c2:
        st.metric("Net Jan 2026 (VND)", f"{net_2026:,.0f}", f"{pct_net:+.1f}%")
    with c3:
        st.metric("Transactions Jan 2025", f"{tx_2025:,}", "")
    with c4:
        st.metric("Transactions Jan 2026", f"{tx_2026:,}", f"{pct_tx:+.1f}%")
    with c5:
        st.metric("Guests (unique) Jan 2025 vs Jan 2026", f"{guests_2025:,} → {guests_2026:,}", f"{pct_guests:+.1f}%")
